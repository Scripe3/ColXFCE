...
def install():
    ...
    r2 = run("apt-get install -y xfce4 xfce4-goodies x11vnc xvfb dbus-x11 wget curl novnc websockify", "almost all the necessary equipment is being installed")
...
def start_core():
    ...
    run_bg_env("dbus-launch startxfce4", "XFCE starter", env)
    time.sleep(5)
